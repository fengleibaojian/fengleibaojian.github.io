...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>您订购的 恭恭恭恭恭恭恭恭恭恭恭 邮政EMS 已发货 请注意收货 <font color="#FF0000">√</font></p>'
	quotes[2]='<p>您订购的 喜喜喜喜喜喜喜喜喜喜喜 顺风速递 已发货 请注意收货 <font color="#FF0000">√</font></p>'
	quotes[3]='<p>您订购的 发发发发发发发发发发发 申通快递 已发货 请注意收货 <font color="#FF0000">√</font></p>'
	quotes[4]='<p>您订购的 财财财财财财财财财财财 中通速递 已发货 请注意收货 <font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
